...
namespace WeChat.Pay.Request
{
    ...
    /// </summary>
    public class WeChatPayTransactionsNativeRequest : WeChatPayHttpReqestBase<WeChatPayTransactionsNativeResponse>
    {
        protected override string EndpointName => WeChatPayEndpoints.TransactionsNative;

        /// <summary>
        /// 实例化一个
        /// </summary>
        public WeChatPayTransactionsNativeRequest()
        {
        }
        ...
        public WeChatPayTransactionsNativeRequest(string description, string outTradeNo, string notifyUrl, int amountTotal, string payerOpenId)
        {
    ...
    /// </summary>
    public class WeChatPayTransactionsH5Request : WeChatPayHttpReqestBase<WeChatPayTransactionsH5Response>
    {
        protected override string EndpointName => WeChatPayEndpoints.TransactionsH5;

        /// <summary>
        /// 实例化一个
        /// </summary>
        public WeChatPayTransactionsH5Request()
        {
        }
        ...
        /// <param name="amountTotal">订单金额</param>
        /// <param name="payerOpenId">支付者openid</param>
        public WeChatPayTransactionsH5Request(string description, string outTradeNo, string notifyUrl, int amountTotal, string payerOpenId)
        {
            Description = description;
            OutTradeNo = outTradeNo;
            NotifyUrl = notifyUrl;
