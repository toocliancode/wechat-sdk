...
/// 【微信支付】查询订单
/// 
/// <para>文档：<a href="https://pay.weixin.qq.com/wiki/doc/apiv3/apis/chapter3_1_2.shtml"></a></para>
/// <para>接口最后更新时间：2021.1.14</para>
/// </summary>
public class TransactionsQuery
{
    ...
    public class GetById(string transactionId) : WeChatPayHttpRequest<Response>
    {
        ...
        {
            var url = $"{WeChatPayProperties.Domain}{Endpoint}".Replace("{transaction_id}", TransactionId).Replace("{mchid}", Options.MchId);
    ...
    public class GetByOutTradeNo(string outTradeNo) : WeChatPayHttpRequest<Response>
    {
        ...
        protected override Task InitializeRequestMessageAsync(IHttpRequestContext context)
        {
            var url = $"{WeChatPayProperties.Domain}{Endpoint}".Replace("{out_trade_no}", OutTradeNo).Replace("{mchid}", Options.MchId);
