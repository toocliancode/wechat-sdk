...
namespace WeChat.Pay.Request
{
    ...
    {
        protected override string EndpointName => WeChatPayEndpoints.TransactionsJsapi;

        /// <summary>
        /// 实例化一个JSAPI 统一下单请求
        /// </summary>
        public WeChatPayTransactionsJsapiRequest()
        {
        }
        ...
        public WeChatPayTransactionsJsapiRequest(string description, string outTradeNo, string notifyUrl, int amountTotal, string payerOpenId)
        {
