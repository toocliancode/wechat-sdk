...
/// 【微信支付】H5下单
/// 
/// <para>文档：<a href="https://pay.weixin.qq.com/wiki/doc/apiv3/wxpay/pay/transactions/chapter3_4.shtml"></a></para>
/// <para>接口最后更新时间：2022.09.05</para>
/// </summary>
public class TransactionsH5
{
    ...
    public class Response : WeChatHttpResponse
    {
        /// <summary>
        /// 支付跳转链接
        /// h5_url为拉起微信支付收银台的中间页面，可通过访问该 url 来拉起微信客户端，完成支付，h5_url的有效期为5分钟。
        /// </summary>
        /// <remarks>
