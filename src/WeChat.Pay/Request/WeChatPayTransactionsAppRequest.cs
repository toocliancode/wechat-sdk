...
namespace WeChat.Pay.Request
{
    ...
    /// </summary>
    public class WeChatPayTransactionsAppRequest : WeChatPayHttpReqestBase<WeChatPayTransactionsAppResponse>
    {
        protected override string EndpointName => WeChatPayEndpoints.TransactionsApp;
        ...
        public WeChatPayTransactionsAppRequest(string description, string outTradeNo, string notifyUrl, int amountTotal, string payerOpenId)
        {
